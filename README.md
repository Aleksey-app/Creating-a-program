...
Для решения системы линейных алгебраических уравнений методом простых итераций с заданной точностью ```e=10(−7)``` нам понадобятся итерации по следующей формуле:

![изображение](https://github.com/Aleksey-app/Creating-a-program/assets/71906604/4f4aea44-2143-4ab5-8582-b8a917adf435)
